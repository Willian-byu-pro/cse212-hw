public static class UniqueLetters {
    ...
    private static bool AreUniqueLetters(string text) {
        // TODO Problem 1 - Replace the O(n^2) algorithm to use sets and O(n) efficiency
            ...
            var set1 = new HashSet<char> (text); //cria um conjunto onde os valores não se repetem
            List<char> set2 = new(text); // conta quanto o numero de itens no conjunto sem os repetidos
